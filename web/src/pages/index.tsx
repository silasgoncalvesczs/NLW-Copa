...
// JSX - javaScritp + XML (html)
// export default function Home(props: HomeProps) {
//   return (
//     <div>
//       <h1 className="text-violet-800 font-bold text-4xl">Hello NLW Copa</h1>
...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent) {
    ...
    try {
      ...
      alert('Bolão criado com sucesso, o cóldigo foi copiado para a área de transferência!')
      setPoolTitle('')
    }
    catch (err) {
      console.log(err)
    ...
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center'>
      <main>
        ...
        <form onSubmit={createPool} action="" className='mt-10 flex gap-2'>
          <input className='flex-1 px-6 py-4 rounded bg-gray-800 border-gray-600 text-sm text-gray-100'
            type="text"
